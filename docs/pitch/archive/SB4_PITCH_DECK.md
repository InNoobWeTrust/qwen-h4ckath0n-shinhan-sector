...
- **60%** are simple reminders: "Please pay your bill"
- **20%** are basic questions: "How much do I owe?"
- **15%** need negotiation: "I can't pay full amount"
- **5%** are complex: needs human judgment
...
| Issue | Impact |
|---|---|
| Cost Impact | Average collection call costs $2-5 per attempt (human agent) |
| High Turnover | Vietnam call center turnover is 30-50% annually |
| Compliance Risk | Inconsistent messaging causes regulatory issues |
| Peak Bottleneck | 9-11 AM, 2-4 PM create service delays |
| Customer Preference | Customers prefer self-service for simple inquiries |
...
Nothing for **80%** of calls. Handling objections, yes. But structured reminders? **No.**
...
| Feature | Description |
|---|---|
| Automatic First-Touch | Handles initial collection calls without human intervention |
| Natural Vietnamese | Conversation with tone awareness |
| Policy Compliance | Stays within script boundaries and offer rules |
| Intent Capture | Records customer intent and promise-to-pay commitments |
| Intelligent Routing | Transfers complex cases to human agents with full conversation context |
...
| Benefit | Description |
|---|---|
| [X]% automation | of first-touch calls handled automatically |
| Reduced cost | per collection attempt |
| Consistent compliance | policy compliance across all calls |
...
| Benefit | Description |
|---|---|
| [X]% automation | of outbound sales calls handled for product info |
| 24/7 availability | for simple inquiries |
| More human time | for high-value sales conversations |
...
**Deploy for payment reminder calls**
...
**Add negotiation capabilities for hardship cases**
...
**Full integration with CRM and call center**
...
- **Working voice agent prototype** (today)
- **Clear path to production** as first-touch automation
- **Team that understands** voice AI + banking compliance
