...
## Slide 3: The Insight (First Principles)
...
## Slide 4: The Solution (Two-Sided)
...
*[Demo placeholder: Show actual scan → offer → merchant dashboard flow]*
...
## Slide 8: The Hacker Advantage (Why Us, Why Now)
...
| Feature | Traditional Loyalty | E-wallets | Shinhan Connect |
|---------|---------------------|-----------|-----------------|
